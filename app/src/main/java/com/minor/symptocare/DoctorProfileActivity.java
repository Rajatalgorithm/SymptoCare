...
public class DoctorProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextAgeProfile = findViewById(R.id.editTextAgeProfile);
        editTextDegreeProfile = findViewById(R.id.editTextDegreeProfile);
        ...
        buttonSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                auth.signOut();
                startActivity(new Intent(DoctorProfileActivity.this,SignInActivity.class));
                finish();
            }
        });
    }
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            reference.child("Users").child(auth.getUid()).child("image").setValue(filePath).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toast.makeText(DoctorProfileActivity.this, "Write to database is successful", Toast.LENGTH_SHORT).show();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(DoctorProfileActivity.this, "An error occurred", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
